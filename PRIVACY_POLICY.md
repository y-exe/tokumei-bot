...
1. 利用規約に違反する投稿に対し、システムによる自動かつ匿名の処罰（警告、利用制限など）を行うため。
2. ユーザーからのメッセージ通報機能において、システムを通じた匿名処罰を実行するため。
...
1. **システムを通じた匿名処罰の実行:**
    利用規約違反の調査や通報への対応において、本Botのシステムが自動的に情報を処理し処罰を実行しますが、サーバー運営者（管理者権限を持つ者）であっても元の送信者情報（Discord IDやプロフィール）を直接閲覧・開示することはできません。
    万が一開示が必要な際は際はBot開発者であるyexeが担当しますが、基本完全にBot・システム上で完結する形になります。
2. **法令に基づく場合:**
    人の生命、身体または財産の保護のために必要がある場合や、国の機関もしくは地方公共団体などから法令に基づく正式な開示請求があった場合。

## 第6条（情報の管理と保護）

本Botは、収集した情報を適切に管理し、情報の漏洩、滅失または毀損の防止その他安全管理のために必要かつ適切な措置を講じます。本Botでは管理者に対するユーザー情報の開示機能（旧`/id`コマンド等）を完全に撤廃しており、通報・処罰の全プロセスにおいてユーザーのプライバシー保護を最優先としています。ユーザーから自己の情報について開示、訂正、削除、利用停止の請求があった場合、法令およびDiscordの仕様に基づき適切に対応します。

## 第7条（プライバシーポリシーの変更）

本Bot運営者は、必要に応じて本ポリシーを変更することができます。変更後のプライバシーポリシーは、当Githubリポジトリに掲載された時点から効力を生じるものとします。

## 第8条（お問い合わせ）

本ポリシーに関するご質問、ご懸念、または情報の取り扱いに関するお問い合わせは、以下の連絡先までお願いします。

* **連絡先 (Discord ID):** `yexe.xyz`
